...
def compose(source,comparisons,endpoint,supplements,baselines,extra,output):
    ...
    methods={'registration':'https://github.com/yjcyxky/virtual-cell-challenge/issues/20#issuecomment-5746896397',
        ...
        'future_availability':'endpoint inferred type and cycle are post-measurement; task-specific NTC and common-support weights use observed target-stratum counts. Source NTC baselines require available same-context control. No claim these covariates or weights are available before a future perturbation',
